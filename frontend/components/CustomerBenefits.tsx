      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-center text-lg max-md:text-base max-md:text-balance">
            We control the full chain – design, software, avionics, airframes
            and integration. This allows us to guarantee availability, fast
            adaptations to customer requirements, technology transfer and
            licensed local production in partner countries.
          </p>
        </div>
        <div>
          <a

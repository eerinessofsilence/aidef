export default function DroneCarouselSection() {
  return (
    <section className="container mx-auto flex aspect-1140/640 items-center justify-center max-lg:aspect-335/700 max-md:px-10 md:py-8 xl:py-16">
      <div className="relative bg-[url(/drone-carousel-bg.png)] bg-size-[100%_100%] bg-center bg-no-repeat max-lg:h-full max-lg:w-[75%] max-lg:bg-[url(/drone-carousel-bg-mobile.svg)] max-md:h-full max-md:w-full">
        ...
        <div className="flex lg:items-end lg:justify-end">
          <div className="text-background flex gap-15 p-10 px-52.5 text-2xl font-bold max-xl:gap-12 max-xl:p-8 max-xl:px-47 max-lg:p-93 max-lg:px-15 max-lg:text-3xl max-md:gap-7 max-md:p-23 max-md:px-5.5 max-md:text-lg">
            <h1>48MP</h1>
            <h1>MD550</h1>
          </div>
        </div>

...
export default function Products() {
  ...
  return (
    <div className="container mx-auto min-h-screen space-y-16 pt-48 pb-24">
        ...
        <div className="relative grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base text-white/70">
              The unmanned aerial vehicle AX2NG KRAKATIT have demonstrated the
              ability to perform many types of missions and may perform more
          ...
          <div className="relative">
            ...
            <div className="relative flex h-full flex-col justify-between rounded-4xl border border-white/15 bg-black/40 p-8 backdrop-blur-2xl">
              <div>
                <p className="text-sm tracking-wide text-white/50 uppercase">
                  {heroProduct?.category?.name ?? "Aerial System"}
                </p>
                <h2 className="mt-2 text-4xl font-semibold">
                  {/* {heroProduct?.name ?? "Aerial Platform"} */} AX2NG
                  KRAKATIT
                </h2>
